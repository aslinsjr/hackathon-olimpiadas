  ...
  return (
    <div className="header-container" style={darkMode ? { backgroundColor: "var(--dark-blue)", boxShadow: "1px 1px 0.5rem 1px var(--dark-gray)"} : {}}>
      ...
      <div className="light-and-dark" style={logoSize == 400 ? {opacity:'0.5'} : {}}>
        ...
        <h2 style={logoSize == 400 ? {display:'none'} : {}}><span style={darkMode ? {color:"var(--dark-gray)", fontWeight: "bolder"} : {}}>Dark</span> / <span style={!darkMode ? {color:"var(--dark-gray)", fontWeight: "200"} : {}}>Light</span></h2>
      </div>
